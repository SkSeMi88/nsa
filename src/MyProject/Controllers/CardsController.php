...
*/
        if (!empty($_POST)){
            ...
            if (count($errors)>0){
                $this->view->renderHtml('cards/create_card3.php',["errors" => $errors, "ThemList" => $ThemList, "msgs" => $msgs]);
                exit;
            }
        }
...
*/
        ...
        // echo "</pre>";
        // $this->view->renderHtml('cards/view_card.php',["card" => $card, "errors" => $errors, "ThemList" => $ThemList, "msgs" => $msgs]);
        $this->view->renderHtml('cards/view_card2.php',["card" => $card, "errors" => $errors, "ThemList" => $ThemList, "msgs" => $msgs]);
    }
