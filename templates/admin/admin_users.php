...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Администрирование системы: пользователи</title>
...
<?php
echo "Раздел администрирования пользователей (".(count($users)-1).")";
?>
    <div class="box">
        ...
        <?php
            ...
            */
            ...
            <div class="rline"   style="display:flex;">
                ...
                <div class="element">
                    <textarea>Электронная почта</textarea>
                    <!-- Имя -->
                </div>
                <div class="element">
      ...
      protected 'id' => string '2' (length=1) -->
            ...
            foreach($users AS $r){
                ...
                echo '<form name="edit_user_form" action="" method="POST" onsubmit="return checkUsersListForm();">';
                echo '<div class="rline"   style="display:flex;">';

                ?>

                <div class="element"  style="width:40px;">
                    <input type="checkbox" name="user_state" value="" <?= $checked_state[$r->getState()];?>>
                </div>
                ...
                <div class="element">
                    <!-- <textarea name="user_passwordHash" id="user_passwordHash"><?//=$r->getPasswordHash();?></textarea> -->
                    <input type="text" name="user_passwordHash" id="user_passwordHash" value="">
                </div>
