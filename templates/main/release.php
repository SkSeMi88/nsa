...
<!---->
	...
	План на 2023 год
		Добиться четкой схемы как и где хранятся данные, чтобы сделать загрузку изображений в нужные разделы системы
		Обновить интерфейс:
				стили
				пагинация
				и прочее
	...
	Созданы разделы/страницы:
			Архивный шифр
			Создания карточки документа
			Страница карточки документа
			Список карточек отмеченных на удаление (они просто пока помечаются красной отметкой при просмотре)
			Список тематик
			Список персоналий
			Поиск карточек документов по  их полям
